...
@Component({
    selector: 'jhi-map-lbs',
    templateUrl: './map-lbs.component.html'
})
export class MapLbsComponent implements OnInit, OnDestroy {
...
currentAccount: any;
    ...
    transition() {
        this.router.navigate(['/map-lbs'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: MapLbs) {
        return item.id;
    }
