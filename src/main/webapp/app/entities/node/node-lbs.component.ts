...
@Component({
    selector: 'jhi-node-lbs',
    templateUrl: './node-lbs.component.html'
})
export class NodeLbsComponent implements OnInit, OnDestroy {
...
currentAccount: any;
    ...
    transition() {
        this.router.navigate(['/node-lbs'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: NodeLbs) {
        return item.id;
    }
